...
<br>
        ...
        <div class="item">
            ...
            <p> <b>Description:</b><?php echo $row['description']; ?>
                <br>
                <br>
                <span><b>Date Added:</b>  <?php echo $row['created_date']; ?>  &nbsp;&nbsp;&nbsp;<b>Country:</b>  <?php echo $row['country']; ?>
                <br />
                <b>Added By:</b>  <?php echo $row['added_by']; ?> &nbsp;&nbsp;&nbsp;<b>Category:</b>  <?php echo $row['category']; ?> </span>
            </p>
